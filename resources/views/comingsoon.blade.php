...
<head>
    ...
    <title>Innovative Your Game | Coming Soon</title>

    <meta name="description" content="BCA-AIA - Innovative Your Game Award">
    <meta name="keywords" content="bca, aia, bcaxaia, Innovative, ready player one, event bca, event aia">
        ...
        <div class="nk-fullscreen-block">
            <div class="nk-fullscreen-block-top">
                <div class="text-center">
                    ...
                    <a href="index.html"><img src="assets/images/logo/logo.png" style="max-width: 240px;max-height: 240px;" alt="Innovative Awards"></a>
            ...
            <div class="nk-fullscreen-block-middle">
                <div class="container text-center">
                    ...
                    <div class="nk-gap-2"></div>
                    <div class="nk-countdown nk-countdown-center" data-end="2021-03-24 00:00" data-timezone="EST"></div>
                    <!-- END: Countdown -->
                </div>
            </div>
