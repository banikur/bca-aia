        ...
        <div class="container">
            <div class="nk-nav-table">
                ...
                <ul class="nk-nav nk-nav-right d-none d-lg-table-cell" data-nav-mobile="#nk-nav-mobile">
                    @if (Route::has('login'))
                    @auth
                    <li class="scroll"><a class="navbar-brand" href="{{ url('/') }}">Dashboard</a></li>
                    <li class="scroll"><a class="navbar-brand" href="{{ url('/home') }}">Home</a></li>
                    <li class="scroll"><a class="navbar-brand" href="{{ url('/logout') }}">Logout</a></li>
                    @else
